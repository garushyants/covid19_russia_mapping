...
!!!Обновление от 30.03.2020!!! В версии, которую Вы видите сейчас мы используем данные по ИВЛ для всех регионов, основанные на анализе закупок, проведенных компанией Headway. Эти данные взяты из репозитория [ikashnitsky](https://github.com/ikashnitsky/covid19-russia). Данные по количеству критических больных на один аппарат ИВЛ для некоторых регионов отличаются от тех, которые Вы могли видеть в исходной версии.
